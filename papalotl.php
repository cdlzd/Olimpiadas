...
// Consulta para obtener los equipos y sus calificaciones en la categoría 'Papalotl'
$query = "
    ...
    WHERE cat.nombre_categoria = 'Papalotl'
    GROUP BY e.id
...
<head>
    ...
    <title>Ranking de la Categoría Papalotl</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5">
        <h1>Ranking de la Categoría Papalotl</h1>
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>No hay calificaciones disponibles para la categoría Papalotl.</p>";
        }
        ?>
