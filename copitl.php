...
// Consulta para obtener los equipos y sus calificaciones en la categoría 'Copitl'
$query = "
    SELECT 
        e.nombre_equipo, 
    ...
    WHERE cat.nombre_categoria = 'Copitl'
...
<head>
    ...
    <title>Ranking de la Categoría Copitl</title>
...
<body>
    ...
    <div class="container mt-5">
        <h1>Ranking de la Categoría Copitl</h1>
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>No hay calificaciones disponibles para la categoría Copitl.</p>";
        }
        ?>
